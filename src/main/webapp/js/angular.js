...
function createHttpBackend($browser, createXhr, $browserDefer, callbacks, rawDocument) {
  ...
  return function(method, url, post, callback, headers, timeout, withCredentials, responseType) {
    ...
    if (lowercase(method) == 'jsonp') {
      ...
      // ark_adius: Zamiast onload został użyty onreadystatechange, bo czasami onload się nie wykonywał (poza tym
      // nie działa na starych IE). SOF na którym było opisane jak go zastąpić:
      // http://stackoverflow.com/questions/14946291/can-one-replace-xhr-onreadystatechange-with-xhr-onload-for-ajax-calls
      xhr.onreadystatechange = function requestLoaded() {
